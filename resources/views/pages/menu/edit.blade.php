...
<form class="settings-form" action=" {{ route('menu.update', $menu->id) }}" method="post" enctype="multipart/form-data">
    ...
    <div class="row g-3 settings-section">
        ...
        <div class="col-12 col-md-4 picture-container" style="display: flex; flex-direction: column; justify-content: center;">
            ...
            <div class="black-screen">{{ $menu->foto }} <p> click to change </p></div>
        </div>
            ...
            <div class="app-card app-card-settings p-4">
                <div class="app-card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" id="nama" value="{{ old('nama', $menu->nama) }}" required>
                        @error('nama')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('harga_modal') is-invalid @enderror" id="harga_modal" name="harga_modal" value="{{ old('harga_modal', number_format($menu->harga_modal,0,',','.')) }}" required>
                        @error('harga_modal')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="harga_jual" class="form-control" id="harga_jual" value="{{ old('harga_jual', number_format($menu->harga_jual,0,',','.') )}}" required>
                        @error('harga_jual')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select @error('id_kategori') is-invalid @enderror" id="setting-input-4" name="id_kategori"
                            required>
