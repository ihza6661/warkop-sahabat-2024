                ...
                <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                        <div class="avatar flex-shrink-0">
                            <img src="{{ asset('assets/images/icons/unicons/chart-success.png') }}" width="40" alt="chart success"
                                class="rounded" />
                        </div>
                    </div>
                    <span class="fw-semibold d-block mb-1 text-dark">Belum dibayar</span>
                    <small class="text-success fw-semibold"><i
                            class="bx bx-up-arrow-alt"></i>{{ $total_unpaid[0]->total_unpaid }} transaksi</small>
                </div>
            </div>
        </div>
        <div class="col-lg-5 col-md-12 col-6 mb-4 shadow rounded">
            <div class="card">
                <div class="card-body">
                    ...
                    <span class="fw-semibold d-block mb-1 text-dark">Dibayar</span>
                    <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i>
                        {{ $total_paid[0]->total_paid }} transaksi</small>
                </div>
            </div>
        </div>
    </div>
